...
%global d_commit 64eb95eb1b218342a99203f95e6c5cea9e7a056e
...
Source0: https://github.com/rhatdan/%{name}/archive/%{d_commit}/%{name}-%{d_shortcommit}.tar.gz
...
Source8: https://github.com/projectatomic/%{name}-storage-setup/archive/%{dss_commit}/%{name}-storage-setup-%{dss_shortcommit}.tar.gz
# Source9 is the source tarball for docker-utils
Source9: https://github.com/vbatts/%{name}-utils/archive/%{utils_commit}.tar.gz
BuildRequires: git
...
if %{_sbindir}/selinuxenabled ; then
    ...
    %relabel_files
    if [ $1 -eq 1 ]; then
    restorecon -R %{_sharedstatedir}/%{name}
    fi
fi
%endif # with_selinux
...
* Wed Jan 20 2016 Lokesh Mandvekar <lsm5@fedoraproject.org> - 0:1.9.1-4.git64eb95e
- built docker @projectatomic/fedora-1.9 commit#2f940c1
- built docker-selinux commit#e2e1f22
- built d-s-s commit#1c2b95b
- built docker-utils commit#dab51ac

* Tue Nov 24 2015 Lokesh Mandvekar <lsm5@fedoraproject.org> - 0:1.9.1-3.git64eb95e
- built docker @projectatomic/fedora-1.9 commit#64eb95e
- built docker-selinux commit#dbfad05
- built d-s-s commit#0814c26
- built docker-utils commit#dab51ac

* Fri Nov 20 2015 Lokesh Mandvekar <lsm5@fedoraproject.org> - 0:1.9.1-2.git78bc3ea
- built docker @projectatomic/fedora-1.9 commit#78bc3ea
- built docker-selinux commit#dbfad05
- built d-s-s commit#0814c26
- built docker-utils commit#dab51ac

* Fri Nov 13 2015 Lokesh Mandvekar <lsm5@fedoraproject.org> - 0:1.8.2-8.git8f9eabc
- built docker @rhatdan/fedora-1.8 commit#8f9eabc
- built docker-selinux commit#dbfad05
- built d-s-s commit#c638a60
- built docker-utils commit#dab51ac

* Mon Oct 12 2015 Lokesh Mandvekar <lsm5@fedoraproject.org> - 1.8.2-7.gitcb216be
